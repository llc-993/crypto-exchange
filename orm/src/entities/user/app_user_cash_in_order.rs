...
crud!(AppUserCashInOrder {}, "app_user_cash_in_order");

impl AppUserCashInOrder {
    pub const TABLE_NAME: &'static str = "app_user_cash_in_order";
}
